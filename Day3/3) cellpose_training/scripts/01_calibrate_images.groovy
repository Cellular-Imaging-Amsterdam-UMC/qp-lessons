/*************************************************************
 * Calibrate All Images in Project (QuPath 0.6.x)
 *
 * PURPOSE
...
if (project == null) {
    Dialogs.showErrorMessage("Calibration", 
...
if (!Dialogs.showParameterDialog("Set Image Calibration", params)) {
...
if (pixelSize <= 0) {
    Dialogs.showErrorMessage("Calibration", "Pixel size must be greater than 0!")
    return
}
...
Dialogs.showInfoNotification("Calibration Complete", message)
