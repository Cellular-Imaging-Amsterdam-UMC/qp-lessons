...
4.  **Install PyTorch**:
    *   *For GPU (CUDA 11.8 example - check [pytorch.org](https://pytorch.org/) for your system):*
        ```bash
...
*   **Cellpose Extension**: Go to the [BIOP Cellpose GitHub](https://github.com/BIOP/qupath-extension-cellpose/releases) and download the latest `.jar` file (e.g., `qupath-extension-cellpose-x.x.x.jar`).
